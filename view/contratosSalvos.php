    ...
    <tbody>
        <?php
            while($user_data = mysqli_fetch_assoc($result)){
                ...
                echo "<td>
                    <a class='btn btn-primary' href='editContrato.php?id=$user_data[contrato]' title='Editar'>
                    ...
                    <a class='btn btn-danger' href='delete.php?id=$user_data[contrato]' title='Deletar'>
